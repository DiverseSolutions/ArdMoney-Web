    ...
    <PageContainer>
      ...
      <Section style="md:mt-layout-xl">
        <div
          data-aos="fade-up"
          data-aos-delay="800"
          className="grid grid-cols-2 md:grid-cols-4 z-30 text-white"
        >
      ...
      <Section style="relative">
        ...
        <div className="z-10 grid grid-cols-1 md:grid-cols-3 gap-6 ">
          <Card>
            ...
            <span className="text-md md:text-base md:w-11/12 font-medium">
      ...
      <Section style="">
        <Card style="justify-center relative md:top-10 border-none text-center px-0 py-0 md:p-base">
          ...
          {faqs.map((faq) => (
            ...
            >
              <div className="flex transition-all ease-linear delay-100 bg-black flex-col w-full border rounded-lg p-[1px] text-white">
                <div
                  className={`flex justify-between items-center w-full item p-6 bg-black back rounded-lg`}
                >
                ...
                {faqAccordionState == faq.id && (
                  <div
                    ...
                    data-aos-delay="500"
                    className={`flex transition-all flex-col md:flex-row px-6 pb-6 bg-black text-justify rounded-bl-lg rounded-br-lg w-full gap-6`}
                  >
