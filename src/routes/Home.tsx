  ...
  return (
    <div className="relative flex flex-col w-full bg-black min-h-screen h-full">
      <div className="relative flex flex-col items-center w-full h-full p-6 lg:p-0">
        <Card style="lg:px-32 pt-32 pb-32 lg:pb-64 text-center z-10 border-none">
          <span className="text-white/60 text-base md:text-xl">
            First Mongolian DAO
          </span>
          <div className="flex flex-col gap text-2xl md:text-4xl font-extrabold leading-none text-white">
        ...
        <div>
          ...
          <img
            src={Background2}
            alt=""
            className="absolute w-full left-0 hidden md:flex bottom-4/4 md:mt-32 lg:mt-0"
          />
          <img
            src={Ellipse}
            alt=""
            className="absolute w-full left-0 top-1/4 mt-24"
          />
          <img src={TextBg} alt="" className="absolute w-full left-0 top-2/4" />
          <img
            src={Blog_rectangle}
            alt=""
            className="absolute w-full left-0 bottom-0 mb-96"
          />
          <img
            src={Ellipse101}
            alt=""
            className="absolute w-full left-0 bottom-0 -pb-96 lg:-pt-96"
          />
          <img
            src={Ellipse102}
            alt=""
            className="absolute w-full right-0 bottom-0 -pb-96 lg:-pt-96"
          />
        </div>
        ...
        <div className="flex w-full justify-center items-center bg-black">
          <div className="flex flex-col max-w-6xl w-full justify-between">
            <div data-aos="fade-up" data-aos-delay="800"
              className="grid grid-cols-2 md:grid-cols-4 z-30 text-white w-full pt-64 pb-32 px-0 ">
              <div className="flex flex-col text-center p-base font-extrabold">
                <span className="text-xl md:text-3xl lg:text-4xl">0.03₮</span>
                <span className="text-2xs md:text-md lg:text-base">
                  ARDM PRICE
                </span>
              </div>
              <div className="flex flex-col text-center p-base font-extrabold">
            ...
            <div className="flex mt-5 flex-col w-full justify-center items-center gap-5 mb-16 md:mb-32 z-10">
              <Card style="text-center max-w-lg border-none p-0">
                ...
                <span className="text-white/60 text-xs md:text-base">
                  ...
                  financial system and are dedicated to being the fastest, most
                  reliable and secure transactions service that can be used by
            ...
            <div className="flex flex-col pt-16 gap-6 bg-transparent">
              <Card style="h-[363px] bg-transparent bg-gradient-to-r from-[#8362FD] to-[#3FE600] p-[1px]">
                <div className="flex flex-col absolute bottom-0 justify-end gap-4 p-6 text-white w-full md:w-4/12 back rounded-tl-lg rounded-bl-lg z-10 bg-transparent">
                  ...
                  <span className="font-normal text-md md:text-base">
                    Ardmoney is a decentralized protocol providing financial
                    services, such as Lending, Borrowing, Liquidity mining,
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ">
                <Card>
                  ...
                  <span className="text-md md:text-base w-11/12 font-medium">
                    Facilitating permissionless decentralized lending.
                  </span>
                  <span className="text-white/60 text-xs md:text-sm font-light">
                    ArdMoney protocol users are able to save with high interest
                    and borrow with low interest.
                  </span>
                </Card>
                <Card>
                  <span className="text-base md:text-xl font-extrabold">
                  ...
                  <span className="text-md md:text-base w-6/12 font-medium">
                ...
                <Card>
                  ...
                  <span className="text-white/60 text-xs md:text-md font-light">
                    ...
                    holders which ensures the protocol serves the best interest
                    of the people.
                  </span>
                </Card>
              </div>

              <Card style="justify-center border-none p-0 pt-12 pb-8 md:pt-32 md:pb-16 text-center">
                  <span className="uppercase text-xl md:text-3xl font-extrabold text-white">
                    getting <br /> confused is <br /> okay. <br />{" "}
                    we will help you <br /> to{" "}
                    <span data-aos="fade-up" data-aos-delay="300" className="text-[#3FE600] ">understand</span> <br />
                    these <span data-aos="fade-up" data-aos-delay="800" className="text-[#8362FD]">concepts</span>
                  </span>
              </Card>

              <Card style="border-none px-0">
                {faqs.map((faq) => (
                  <button key={faq.id} onClick={() => {
                    ...
                    <div className="flex transition-all ease-linear delay-100 bg-black flex-col w-full border rounded-lg p-[1px] text-white">
                      <div className={`flex justify-between items-center w-full item p-6 bg-black back rounded-lg`} >
                        <span className="text-base md:text-xl font-extrabold uppercase">
                          {faq.title}
                        </span>
                        <div className={`h-4 w-4 md:h-6 md:w-6 relative transition ${faqAccordionState == faq.id ? "rotate-180" : "rotate-0" }`} >
                          <img src={Chevron} alt="image" />
                        </div>
                      </div>
                      {faqAccordionState == faq.id && (
                        <div data-aos="fade-down" data-aos-easing="linear" data-aos-delay="500" className={`flex transition-all flex-col md:flex-row px-6 pb-6 bg-black text-justify rounded-bl-lg rounded-br-lg w-full gap-6`}>
                          ...
                          <div className="flex flex-col md:w-1/2 gap-4">
                            ...
                            <span className="text-sm md:text-md text-white/60 font-light">
                              Ardmoney is fully democratized and is governed by
                              its token holders which ensures the protocol serves
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-base md:gap-xl lg:gap-10 w-full text-white">
                  <div className="flex border rounded-lg md:mb-16 bg-gradient-to-r from-[#8362FD] to-[#3FE600] p-[1px] cursor-pointer ">
                    <a
                      ...
                      target={"_blank"}
                      className="flex flex-col p-6 bg-black back rounded-lg text-center"
                    >
