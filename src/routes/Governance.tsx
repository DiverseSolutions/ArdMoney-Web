...
const tabs = [{ text: "All" }, { text: "Active" }, { text: "Finished" }];
  ...
  return (
    <div className="relative flex justify-center min-h-screen w-full">
      <div className="flex flex-col w-full max-w-6xl sm:mb-xl md:mb-2xl z-10 p-6 lg:p-0">
          ...
          <div className="relative flex flex-col staking-header-gradient p-lg w-full h-full bg-black rounded-lg">
            <div className="flex flex-col w-full z-10 lg:w-5/12 text-light/60 text-sm gap-lg">
              <div className="flex gap-base">
                ...
                <span>
                  In CERO governance, the xCERO token you hold is itself a
                  voting right.
                </span>
              </div>
              <div className="flex gap-base">
                <div className="i-ic-round-warning-amber icon-size-5" />
                <span>
                  CERO DAO uses Snapshot to store data in a decentralized way,
                  making it easy to verify user votes. And you don't have to pay
                  any fees to participate in the discussion, it's enough to be a
                  token holder.
                </span>
              </div>
              <div className="flex gap-base">
                <div className="i-ic-round-warning-amber icon-size-5" />
                <span>
                  There are 2 steps to submitting an issue to CERO DAO. First,
                  CERO will discuss the open discussion section, and if the
                  problem or solution is considered by the public or the CERO
                  team needs to be put forward for governance, the DAO vote will
                  officially begin.
                </span>
              </div>
              <div className="flex gap-base">
                <div className="i-ic-round-warning-amber icon-size-5" />
                <span>
                  Dear CERO token holder, if you have a great idea for the
                  development of CERO, please post it on the CERO forum and
                  share your ideas with others. Your new ideas can bring
                  wnoderful changes
                </span>
              </div>
              <div className="flex gap-base">
                <div className="i-ic-round-warning-amber icon-size-5" />
                <span>
                  YOU MUST HAVE YOUR xCERO TOKENS PLACED IN YOUR WALLET BEFORE
                  YOU START VOTING. Snapshot will register your wallet before
                  voting starts, and if you deposit tokens after voting starts,
        ...
        <span className="font-extrabold text-xl text-white mt-16 mb-6">
          VOTES
        </span>
        ...
        <div className="flex gap-sm text-white w-full md:w-1/2">
          {tabs.map((item, index) => (
            <button
              ...
              } py-sm w-1/3 text-center rounded-lg`}
            >
              <span>{item.text}</span>
            </button>
          ))}
        ...
        {selectedIndex === 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="flex flex-col border border-[#ABFC86] p-6 rounded-lg ">
              ...
              <button className="text-left mt-6 text-xl font-extrabold text-white">
                Ardmoney токены нэрийг CERO болгон өөрчлөх
              </button>
              <span className="mt-4 text-white/60 text-base">
                ### Хураангуй * Ardmoney токены нэр нь “CERO” болж шинэчлэгдэнэ
                * ArdMoney Prot
              </span>
