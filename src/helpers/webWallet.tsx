...
//
// export async function encryptArdMoneyWebWallet(wallet:Wallet, password:string) {
//   const secret = process.env.NEXT_PUBLIC_SECRET ?? ""
//   if (secret == "") throw "Secret Empty"
//
//   const jsonWallet = await wallet.encrypt(password, { scrypt: { N: 1 << 10 } })
//   const encryptedWithSecretWallet = CryptoJS.AES.encrypt(JSON.stringify(jsonWallet), secret)
//
//   return encryptedWithSecretWallet
// }
//
// export async function decryptArdMoneyWebWallet(encryptedWallet:string, password:string) {
//   const secret = process.env.NEXT_PUBLIC_SECRET ?? ""
//   if (secret == "") throw "Secret Empty"
//
